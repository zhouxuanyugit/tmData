            ...
            {taglist.map((tag, index) => (
              <li key={tag.path}>
                <Tag
                  ...
                  color={currentPath === tag.path ? "geekblue" : "default"}
                ...
                {/* 设置选中两边的边框取消 */}
                {
                  currentPath === tag.path ?
                    <div className="divider hidden-d"></div> :  // 去掉已经选中自己的右边框
                    index + 1 === taglist.length ?
                      <div className="divider"></div> :
                      currentPath === taglist[index + 1].path ?
                        <div className="divider hidden-d"></div> :  // 去掉已经选中自己的左边的边框
                        <div className="divider"></div>
                }
              </li>
            ))}
